...
def load_vgg(sess, vgg_path):
    ...
    ly3  = graph.get_tensor_by_name(vgg_layer3_out_tensor_name)
    ly4  = graph.get_tensor_by_name(vgg_layer4_out_tensor_name)
    ly7  = graph.get_tensor_by_name(vgg_layer7_out_tensor_name)
    return w1, keep, ly3, ly4, ly7
